...
## Login
### `POST` `/login`
Megkeresi a kapott felhasználónév és jelszó párost az adatbázisban tárolt felhasználók között és visszaadja a felhasználó azonosítóját `User ID` (ha nem található ilyen felhasználó akkor `null`).
### Request
